  ...
  return (
    <footer className="bg-[var(--primary-dark)] text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-white/10 text-center sm:text-left">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {LINKS.map(({ to, label }) => (
                <li key={to}>
                  <Link to={to} className="text-white/70 hover:text-[var(--accent)] text-sm transition-colors flex items-center justify-center sm:justify-start gap-1.5">
          ...
          <div>
            ...
            <ul className="space-y-2">
              {AREAS.map(a => (
                <li key={a}>
                  <Link to="/cursos" className="text-white/70 hover:text-[var(--accent)] text-sm transition-colors flex items-center justify-center sm:justify-start gap-1.5">
          ...
          <div>
            ...
            <div className="mt-6 space-y-3">
              ...
              <img src="/images/certifications/banderas.png"
                loading="lazy" decoding="async"
                alt="Certificaciones internacionales" className="h-6 w-auto object-contain mx-auto sm:mx-0" />
              <img src="/images/payments/3-cuotas-precio-contado.png"
                loading="lazy" decoding="async"
                alt="3 cuotas precio contado" className="h-10 w-auto object-contain mx-auto sm:mx-0" />
            </div>
          </div>
        </div>

        <div className="pt-6 flex flex-col lg:flex-row items-center justify-between gap-3 text-sm text-white/40 text-center">
